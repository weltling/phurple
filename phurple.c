...
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_writeConv, 0, 0, 6)
	    ...
	    ZEND_ARG_INFO(0, timestamp)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_writingImMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(1, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_writingChatMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(1, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_wroteImMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(0, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_wroteChatMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(0, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_sendingImMsg, 0, 0, 2)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(1, message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_sendingChatMsg, 0, 0, 2)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(0, chatId)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_sentImMsg, 0, 0, 2)
	    ZEND_ARG_INFO(0, receiver)
	    ZEND_ARG_INFO(0, message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_sentChatMsg, 0, 0, 2)
	    ZEND_ARG_INFO(0, receiver)
	    ZEND_ARG_INFO(0, chatId)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_receivingImMsg, 0, 0, 3)
	    ZEND_ARG_INFO(1, sender)
	    ZEND_ARG_INFO(1, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_receivingChatMsg, 0, 0, 3)
	    ZEND_ARG_INFO(1, sender)
	    ZEND_ARG_INFO(1, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_receivedImMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, sender)
	    ZEND_ARG_INFO(0, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_receivedChatMsg, 0, 0, 3)
	    ZEND_ARG_INFO(0, sender)
	    ZEND_ARG_INFO(0, message)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_blockedImMsg, 0, 0, 4)
	    ZEND_ARG_INFO(0, sender)
	    ZEND_ARG_INFO(0, message)
	    ZEND_ARG_INFO(0, message_flags)
	    ZEND_ARG_INFO(0, timestamp)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_conversationCreated, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_conversationUpdated, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_deletingConversation, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_buddyTyping, 0, 0, 2)
	    ZEND_ARG_OBJ_INFO(0, account, Phurple\\Account, 0)
	    ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_buddyTypingStopped, 0, 0, 2)
	    ZEND_ARG_OBJ_INFO(0, account, Phurple\\Account, 0)
	    ZEND_ARG_INFO(0, name)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatBuddyJoining, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, buddyflags)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatBuddyJoined, 0, 0, 4)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, new_arrival)
	    ZEND_ARG_INFO(0, buddyflags)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatJoinFailed, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, connection, Phurple\\Connection, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatBuddyLeaving, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, reason)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatBuddyLeft, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, reason)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatInvitingUser, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(1, invite_message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatInvitedUser, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, invite_message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatInvited, 0, 0, 3)
	    ZEND_ARG_INFO(0, inviter)
	    ZEND_ARG_INFO(0, chat)
	    ZEND_ARG_INFO(0, invite_message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatInviteBlocked, 0, 0, 3)
	    ZEND_ARG_INFO(0, inviter)
	    ZEND_ARG_INFO(0, chat)
	    ZEND_ARG_INFO(0, invite_message)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatJoined, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatLeft, 0, 0, 1)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatTopicChanged, 0, 0, 3)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_INFO(0, topic)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_chatBuddyFlags, 0, 0, 4)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
	    ZEND_ARG_INFO(0, name)
	    ZEND_ARG_INFO(0, oldflags)
	    ZEND_ARG_INFO(0, newflags)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(PhurpleClient_requestAction, 0, 0, 8)
	    ZEND_ARG_INFO(0, title)
	    ZEND_ARG_INFO(0, primary)
	    ZEND_ARG_INFO(0, secondary)
	    ZEND_ARG_INFO(0, default_action)
	    ZEND_ARG_OBJ_INFO(0, account, Phurple\\Account, 0)
	    ZEND_ARG_INFO(0, who)
	    ZEND_ARG_OBJ_INFO(0, conversation, Phurple\\Conversation, 0)
...
zend_function_entry PhurpleClient_methods[] = {
	...
	PHP_ME(PhurpleClient, requestAction, PhurpleClient_requestAction, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, writingImMsg, PhurpleClient_writingImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, wroteImMsg, PhurpleClient_wroteImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, sendingImMsg, PhurpleClient_sendingImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, sentImMsg, PhurpleClient_sentImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, receivingImMsg, PhurpleClient_receivingImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, receivedImMsg, PhurpleClient_receivedImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, blockedImMsg, PhurpleClient_blockedImMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, writingChatMsg, PhurpleClient_writingChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, wroteChatMsg, PhurpleClient_wroteChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, sendingChatMsg, PhurpleClient_sendingChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, sentChatMsg, PhurpleClient_sentChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, receivingChatMsg, PhurpleClient_receivingChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, receivedChatMsg, PhurpleClient_receivedChatMsg, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, conversationCreated, PhurpleClient_conversationCreated, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, conversationUpdated, PhurpleClient_conversationUpdated, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, deletingConversation, PhurpleClient_deletingConversation, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, buddyTyping, PhurpleClient_buddyTyping, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, buddyTypingStopped, PhurpleClient_buddyTypingStopped, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatBuddyJoining, PhurpleClient_chatBuddyJoining, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatBuddyJoined, PhurpleClient_chatBuddyJoined, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatBuddyLeaving, PhurpleClient_chatBuddyLeaving, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatBuddyLeft, PhurpleClient_chatBuddyLeft, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatInvitingUser, PhurpleClient_chatInvitingUser, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatInvitedUser, PhurpleClient_chatInvitedUser, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatInvited, PhurpleClient_chatInvited, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatInviteBlocked, PhurpleClient_chatInviteBlocked, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatJoined, PhurpleClient_chatJoined, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatJoinFailed, PhurpleClient_chatJoinFailed, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatLeft, PhurpleClient_chatLeft, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatTopicChanged, PhurpleClient_chatTopicChanged, ZEND_ACC_PROTECTED)
	PHP_ME(PhurpleClient, chatBuddyFlags, PhurpleClient_chatBuddyFlags, ZEND_ACC_PROTECTED)
	{NULL, NULL, NULL}
};
/* }}} */
